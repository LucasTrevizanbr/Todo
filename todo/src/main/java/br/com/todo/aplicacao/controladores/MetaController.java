...
import br.com.todo.aplicacao.dto.MetaDtoDetalhado;
import br.com.todo.aplicacao.dto.MetaDtoSimples;
import br.com.todo.aplicacao.dto.form.MetaFormAtualizacao;
import br.com.todo.aplicacao.dto.form.MetaFormCadastro;
...
public class MetaController {
    ...
    @PutMapping("{idMeta}/concluir/tarefa/{idTarefa}")
    @Transactional
    ...
    @PutMapping("{idMeta}/atualizar/tarefa/{idTarefa}")
    @Transactional
    ...
    @DeleteMapping("{idMeta}/deletar/tarefa/{idTarefa}")
    @Transactional
